...
Then all you have to do is define your stages, pipelines, and start it:
...
You will also need to run your Delayed Job workers that will process the pipeline in the background:
